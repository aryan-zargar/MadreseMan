...
export default function BudgetManagement() {
    ...
    const totalIncome = transactions
        .filter(t => t.type === "income" && t.approved)
        .reduce((sum, t) => sum + t.amount, 0)

    const totalExpenses = transactions
        .filter(t => t.type === "expense" && t.approved)
        .reduce((sum, t) => sum + t.amount, 0)

    // Filter transactions based on selected budget
                            ...
                            <div className='space-y-4'>
                                <div className='bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-200'>
                                    <div className='flex justify-between items-center mb-2'>
                                        <span className='text-sm text-gray-600'>بودجه تخصیص یافته</span>
                                ...
                                <div className='bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-200'>
                                    <div className='flex justify-between items-center mb-2'>
                                        <span className='text-sm text-gray-600'>هزینه شده</span>
                                        {/* <span className='text-lg font-bold text-blue-700'>{formatCurrency(totalSpent)}</span> */}
                                    </div>
                                    {/* <div className='text-xs text-blue-600'>{spentPercentage.toFixed(1)}% از کل بودجه</div> */}
                                </div>

                                <div className='bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200'>
                                    <div className='flex justify-between items-center mb-2'>
                                        <span className='text-sm text-gray-600'>مانده بودجه</span>
                                        {/* <span className='text-lg font-bold text-green-700'>{formatCurrency(totalRemaining)}</span> */}
                                    </div>
                                    {/* <div className='text-xs text-green-600'>{((totalRemaining / totalAllocated) * 100).toFixed(1)}% باقی مانده</div> */}
                                </div>
                                ...
                                <div className='grid grid-cols-2 gap-3'>
                                    ...
                                    <div className='bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-3 border border-red-200'>
                                        <div className='text-sm text-gray-600'>هزینه</div>
