    ...
    return (
        <div className='grid grid-cols-8 h-screen ' >
            <div className='col-span-4 flex justify-center items-center ' >
                <div className='justify-center items-center px-14 py-18 rounded-xl bg-gray-50'>
            ...
            <div className='col-span-4 bg-[#1a1b75] flex justify-center items-center ' >
                <div>
                    <img src={Logo} className='w-[17vw] h-[17vw]' />
                    <div style={{ fontFamily: "sgkara" }} className='flex justify-center -mt-10' >
                        <p className='text-white text-[2.4vw]' >مدرسه من</p>
                    </div>
                </div>
            </div>
        </div>
